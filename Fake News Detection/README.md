...
the original dataset contained 13 variables/columns for train, test and validation .
...
```
$ git clone https://github.com//DommithiDeekshitha/Slash-Mark/Fake_News_Detection.git
```
